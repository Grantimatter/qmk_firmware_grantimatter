...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_EXTRA_GAME_QWERTY)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_GAME_QWERTY_FLIP
    ...
    #elif defined (MIRYOKU_ALPHAS_GAME_QWERTY)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_GAME_QWERTY
    #elif defined (MIRYOKU_ALPHAS_QWERTY)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_GAME_QWERTY)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_GAME_QWERTY_FLIP
    ...
    #elif defined (MIRYOKU_EXTRA_GAME_QWERTY)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_GAME_QWERTY
    #elif defined (MIRYOKU_EXTRA_QWERTY)
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_TAP_GAME_QWERTY)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_GAME_QWERTY
  ...
  #if defined (MIRYOKU_LAYERS_FLIP)
    #define MIRYOKU_LAYER_GAME2 MIRYOKU_ALTERNATIVES_GAME2_FLIP
  #else
